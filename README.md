...
* [Demo](https://github.com/richhaase/building-a-data-pipeline/blob/master/DEMO.md)

### Required Software
* [Virtual Box 5.0](https://www.virtualbox.org/wiki/Download_Old_Builds_5_0)
* [Vagrant](https://www.vagrantup.com/downloads.html) and the vagrant-hostsupdater plugin (if you want to access the demo VM by the name `demo`.
...
* [Avro Archives - Cloudera Engineering Blog](http://blog.cloudera.com/blog/category/avro/?_ga=1.83300182.138278127.1467221383)
* [AWS | Amazon Elastic MapReduce (EMR) | Developer Resources](https://aws.amazon.com/elasticmapreduce/developer-resources/)
...
* [Apache Ranger - Introduction](http://ranger.apache.org/)